...
bitflags! {
    ...
    pub struct LayoutDamage: u16 {
        ...
        const AccessibilityStyleDamage = 0b0000_1000_0000_0000;
        const AccessibilityLayoutDamage = 0b0000_0100_0000_0000;
        const DescendantHasAccessibilityDamage = 0b0000_0010_0000_0000;

        /// Rebuild this box, all of its ancestors and all of its descendants. This is the
        /// most a box can be damaged.
        const BoxDamage = 0b1111_1111_1111_1111;
    }
}
